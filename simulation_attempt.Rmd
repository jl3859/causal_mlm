...
classroom_dat <- classroom_dat %>% 
  mutate(dist.school.hour = dist.school/60,
         pretest = 65 + 0.4*yearstea + 0.3*teach.edu + 0.71*parent.edu + 0.15*fam.income - 2*minority - 1.5*dist.school.hour + rnorm(N, 0 ,1),
         Y0 = 61 + 0 + 0.4*yearstea + 0.33*teach.edu + 0.74*parent.edu + 0.18*fam.income - 2.23*minority - 1.4*dist.school.hour + rnorm(N, 0 ,1),
         Y1 = 61 + 5 + 0.4*yearstea + 0.33*teach.edu + 0.74*parent.edu + 0.18*fam.income - 2.23*minority - 1.4*dist.school.hour + rnorm(N, 0 ,1))
...
X <- rnorm(N, 0, 1)
prob <- inv.logit((X/max(abs(X))) * log(19))
range(prob)
```
